...
public class AnotherConcurrentGUI {
        ...
        public AnotherConcurrentGUI() {
            ...
            final Conteggio conteggio = new Conteggio();
            new Thread(conteggio).start();
                    ...
                    try {
                        ...
                        SwingUtilities.invokeAndWait(new Runnable() {
                            ...
                            public void run() {
                                ...
                                AnotherConcurrentGUI.this.JNum.setText(Integer.toString(Agent.this.counter));
                            }
                        });
                        /*
        ...
        private class Conteggio implements Runnable {
            /*
             * Stop is volatile to ensure visibility. Look at:
             * 
             * http://archive.is/9PU5N - Sections 17.3 and 17.4
